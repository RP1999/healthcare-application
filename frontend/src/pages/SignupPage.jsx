...
const Logo = () => (
  <Box textAlign="center" mb={8}>
    <Text fontSize="3xl" fontWeight="bold" bgGradient="linear(to-r, green.500, blue.600)" bgClip="text">
      MediLink
    </Text>
    ...
    <Container maxW="100%" p={0} minH="100vh">
      ...
      >
        ...
        <ScaleFade in={true} initialScale={0.9}>
          <Flex
            flex="1"
            bgGradient="linear(to-br, green.600, blue.700)"
            color="white"
            ...
            >
              <Fade in={true} delay={0.2}>
                ...
                <Text fontSize="xl" opacity={0.9} lineHeight={1.6} mb={8}>
                  Start your journey in healthcare excellence. Manage patients, appointments, and medical records seamlessly.
                </Text>
          ...
          <Fade in={true} delay={0.4}>
            ...
            >
              <Stack spacing={6}>
                ...
                {/* Name Field */}
                <FormControl isRequired isInvalid={!!errMsg && !form.name.trim()}>
                  <FormLabel fontWeight="600" fontSize="sm" mb={2}>
                    Full Name
                  </FormLabel>
                  <Input
                    name="name"
                    placeholder="e.g. Kavisha Rajapaksha"
                    value={form.name}
                    onChange={onChange}
                    ...
                    size="lg"
                    rounded="lg"
                    borderColor={isFocused.name ? accentColor : "gray.300"}
                ...
                {/* Email Field */}
                <FormControl isRequired isInvalid={!!errMsg && !form.email}>
                  <FormLabel fontWeight="600" fontSize="sm" mb={2}>
                    Email Address
                  </FormLabel>
                  <Input
                ...
                {/* Password Field */}
                <FormControl isRequired isInvalid={!!errMsg && !form.password}>
                  <FormLabel fontWeight="600" fontSize="sm" mb={2}>
                    Password
                  </FormLabel>
                  <InputGroup size="lg">
                ...
                <FormControl isRequired isInvalid={!!errMsg && form.password !== form.confirm}>
                  <FormLabel fontWeight="600" fontSize="sm" mb={2}>
                    Confirm Password
                  </FormLabel>
                  <InputGroup size="lg">
                    <Input
                      ...
                      autoComplete="new-password"
                      rounded="lg"
                      borderColor={isFocused.confirm ? accentColor : "gray.300"}
                      focusBorderColor={accentColor}
                      _hover={{ borderColor: "gray.400" }}
                      transition="all 0.2s"
                    />
